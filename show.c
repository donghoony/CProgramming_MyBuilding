...
void show_gameboard_grid(){
    ...
    printf("弛    AA          弛   AA      BB   弛                弛                弛                弛                弛                弛           AA   弛\n"); //2
    printf("弛                弛                弛                弛                弛                弛                弛                弛                弛\n"); //3
    printf("弛       4        弛                弛                弛                弛                弛                弛                弛        11      弛\n"); //4
    printf("弛          BB    戍式式式式式式式式式式式式式式式式托式式式式式式式式式式式式式式式式托式式式式式式式式式式式式式式式式托式式式式式式式式式式式式式式式式托式式式式式式式式式式式式式式式式托式式式式式式式式式式式式式式式式扣   BB           弛\n"); //5
    printf("弛                弛                弛                弛                弛                弛                弛                弛                弛\n"); //6
    ...
    printf("弛          弛     弛                                                                                                     弛     弛          弛\n"); //8
    printf("弛    AA    弛     弛                                                                                                     弛     弛    AA    弛\n"); //9
    printf("弛          弛     弛                                                                                                     弛     弛          弛\n"); //10
    printf("弛    BB    弛     弛                                                                                                     弛     弛    BB    弛\n"); //11
    printf("弛          弛     弛                                                                                                     弛     弛          弛\n"); //12
    ...
    printf("弛                弛                弛                弛                弛                弛                弛                弛                弛\n"); //26
    printf("弛                戍式式式式式式式式式式式式式式式式托式式式式式式式式式式式式式式式式托式式式式式式式式式式式式式式式式托式式式式式式式式式式式式式式式式托式式式式式式式式式式式式式式式式托式式式式式式式式式式式式式式式式扣   AA           弛\n"); //27
    printf("弛                弛                弛                弛                弛                弛                弛                弛                弛\n"); //28
    printf("弛                弛                弛                弛                弛                弛                弛                弛                弛\n"); //29
    printf("弛                弛<18 AA     BB   弛   AA      BB   弛                弛                弛                弛                弛          BB    弛\n"); //30
    printf("弛                弛                弛                弛                弛                弛                弛                弛                弛\n"); //31
